...
parser.add_option(
    "-t", "--target", action="store", help="The ip address of the target", metavar="10.20.30.48", dest="VictimIP"
)
parser.add_option(
    "-r",
    "--route",
...
parser.add_option(
    "-I", "--interface", action="store", help="Interface name to use, example: eth0", metavar="eth0", dest="Interface"
)
parser.add_option(
    "-a",
    "--alternate",
