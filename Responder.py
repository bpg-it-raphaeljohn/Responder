...
parser.add_option(
    "--disable-ess", action="store_true", help="Force ESS downgrade. Default: False", dest="NOESS_On_Off", default=False
)
...
class ThreadingUDPMDNSServer(ThreadingMixIn, UDPServer):
    def server_bind(self):
        ...
        Join = self.socket.setsockopt(
            socket.IPPROTO_IP, socket.IP_ADD_MEMBERSHIP, socket.inet_aton(MADDR) + settings.Config.IP_aton
        )
